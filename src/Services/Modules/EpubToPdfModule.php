...
/**
 * EpubToPdfModule - EPUB to PDF conversion using LibreOffice
 * Simple, functional LibreOffice headless integration for eBook files
 */
class EpubToPdfModule extends AbstractConversionModule
{
    public function __construct()
    {
        parent::__construct('epub', 'pdf', 'libreoffice');
    }
    
    /**
     * Execute EPUB to PDF conversion using LibreOffice
     */
    protected function executeConversion(string $inputFile, string $outputFile): bool
    {
        ...
        try {
            ...
            Logger::debug('LibreOffice EPUB conversion', [
