...
/**
 * PptxToPdfModule - PPTX to PDF conversion using LibreOffice
 * Simple, functional LibreOffice headless integration for PowerPoint presentations
 */
class PptxToPdfModule extends AbstractConversionModule
{
    public function __construct()
    {
        parent::__construct('pptx', 'pdf', 'libreoffice');
    }
    
    /**
     * Execute PPTX to PDF conversion using LibreOffice
     */
    protected function executeConversion(string $inputFile, string $outputFile): bool
    {
        ...
        try {
            ...
            Logger::debug('LibreOffice PPTX conversion', [
