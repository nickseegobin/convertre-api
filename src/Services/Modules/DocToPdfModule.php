...
/**
 * DocToPdfModule - DOC to PDF conversion using LibreOffice
 * Simple, functional LibreOffice headless integration for legacy Word documents
 */
class DocToPdfModule extends AbstractConversionModule
{
    public function __construct()
    {
        parent::__construct('doc', 'pdf', 'libreoffice');
    }
    
    /**
     * Execute DOC to PDF conversion using LibreOffice
     */
    protected function executeConversion(string $inputFile, string $outputFile): bool
    {
        ...
        try {
            ...
            Logger::debug('LibreOffice DOC conversion', [
