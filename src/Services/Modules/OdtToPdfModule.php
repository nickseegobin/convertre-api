...
/**
 * OdtToPdfModule - ODT to PDF conversion using LibreOffice
 * Simple, functional LibreOffice headless integration for OpenDocument Text files
 */
class OdtToPdfModule extends AbstractConversionModule
{
    public function __construct()
    {
        parent::__construct('odt', 'pdf', 'libreoffice');
    }
    
    /**
     * Execute ODT to PDF conversion using LibreOffice
     */
    protected function executeConversion(string $inputFile, string $outputFile): bool
    {
        ...
        try {
            ...
            Logger::debug('LibreOffice ODT conversion', [
