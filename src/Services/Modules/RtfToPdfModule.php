...
/**
 * RtfToPdfModule - RTF to PDF conversion using LibreOffice
 * Simple, functional LibreOffice headless integration for Rich Text Format files
 */
class RtfToPdfModule extends AbstractConversionModule
{
    public function __construct()
    {
        parent::__construct('rtf', 'pdf', 'libreoffice');
    }
    
    /**
     * Execute RTF to PDF conversion using LibreOffice
     */
    protected function executeConversion(string $inputFile, string $outputFile): bool
    {
        ...
        try {
            ...
            Logger::debug('LibreOffice RTF conversion', [
